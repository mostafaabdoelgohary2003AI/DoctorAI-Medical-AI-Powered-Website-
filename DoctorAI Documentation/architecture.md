...
graph TD
    subgraph "🔑 Layer 4: Authorization"
        D1["👥 Role-Based Access<br/>(RBAC)"]
        D2["🎯 Resource-Level<br/>Permissions"]
        D3["🛡️ API Endpoint<br/>Protection"]
        D4["🤖 Model Access<br/>Control"]
    end
    
    subgraph "🗄️ Layer 5: Data Security"
        E1["🔒 Encryption at Rest"]
        E2["🚀 Encryption in Transit"]
        E3["👤 PII Data<br/>Protection"]
        E4["💾 Secure Model<br/>Storage"]
    end
    
    subgraph "📊 Layer 6: Audit & Compliance"
        F1["📝 Comprehensive<br/>Audit Logging"]
        F2["🚨 Security Event<br/>Monitoring"]
        F3["📋 Compliance<br/>Reporting"]
        F4["⚡ Incident<br/>Response"]
    end
    ...
    classDef datasecurity fill:#e8f5e8,stroke:#4caf50,stroke-width:2px
    classDef compliance fill:#f3e5f5,stroke:#9c27b0,stroke-width:2px
    
    class D1,D2,D3,D4 authorization
    class E1,E2,E3,E4 datasecurity
    class F1,F2,F3,F4 compliance
```
...
```mermaid
graph LR
    subgraph "🧠 Model Cache (Memory)"
        M1["🤖 Loaded AI Models<br/>(Lazy Loading)"]
        M2["⚡ Preprocessed Data"]
        M3["📊 Inference Results"]
        M4["📋 Model Metadata"]
    end
    
    subgraph "💾 Persistent Storage"
        P1["📁 Frequently Accessed<br/>Data"]
        P2["🗄️ Long-term Storage"]
    end
    ...
    classDef memory fill:#ff9800,stroke:#e65100,stroke-width:2px,color:#fff
