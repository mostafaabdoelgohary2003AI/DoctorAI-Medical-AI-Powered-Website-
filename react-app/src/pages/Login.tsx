...
import { AtSign, Lock, AlertCircle, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <p className="mt-10 text-center text-sm text-neutral-500 dark:text-neutral-400">
          ...
          <a
            href="#"
            className="font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300 mx-1"
          >
